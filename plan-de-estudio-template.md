...
**El archivo se actualiza al toque, no después**: en cuanto se cierra un checkpoint, se edita este archivo en ese mismo momento, antes de pasar al siguiente tema — no se deja para el final de la sesión ni se acumulan cierres para volcarlos juntos.
